...
<div class="dark-card" style="max-width: 600px;">
    ...
    <h6 class="mt-3 mb-4" style="color: var(--text-primary); font-weight: 600;">Form Edit Kategori</h6>
    ...
    <form action="{{ route('petugas.kategori.update', $kategori) }}" method="POST">
        @csrf
        @method('PUT')

        <div class="mb-3">
            <label class="form-label" style="font-size: 0.82rem; color: var(--text-secondary);">Nama Kategori</label>
        ...
        <div class="mb-4">
            ...
            <textarea name="keterangan" rows="3"
                      class="form-control"
                      style="background: var(--main-bg); border-color: var(--card-border); color: var(--text-primary); font-size: 0.85rem;">{{ old('keterangan', $kategori->keterangan) }}</textarea>
        </div>
